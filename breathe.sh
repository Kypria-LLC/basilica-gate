...
validate_environment() {
    ...
    [[ -z "
${AUTH0_DOMAIN:-}" ]] && missing_vars+=("AUTH0_DOMAIN")
    [[ -z "
${AUTH0_CLIENT_ID:-}" ]] && missing_vars+=("AUTH0_CLIENT_ID")
    [[ -z "
${AUTH0_CLIENT_SECRET:-}" ]] && missing_vars+=("AUTH0_CLIENT_SECRET")
    [[ -z "
${AUTH0_AUDIENCE:-}" ]] && missing_vars+=("AUTH0_AUDIENCE")
